 ...
 *            .equals(..))
 */
public abstract class MiningStep<NodeType, EdgeType>
    implements Generic<NodeType, EdgeType> {
  ...
  call(SearchLatticeNode<NodeType, EdgeType> node,
  ...
  callNext(final SearchLatticeNode<NodeType, EdgeType> node,
   ...
   */
  public MiningStep<NodeType, EdgeType> getNext() { return next; }
}
