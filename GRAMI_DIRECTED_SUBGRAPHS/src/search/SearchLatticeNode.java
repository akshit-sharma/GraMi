...
public abstract class SearchLatticeNode<NodeType, EdgeType>
  ...
  protected SearchLatticeNode() { this.level = -1; }

  protected SearchLatticeNode(final int level) { this.level = level; }

  /**
   * @return all embeddings of this node
   */
  // public abstract Collection<HPEmbedding<NodeType, EdgeType>>
  // allEmbeddings();
   ...
   *         <code>extension</code>
   */
  public abstract SearchLatticeNode<NodeType, EdgeType>
  extend(Extension<NodeType, EdgeType> extension);
   ...
   * @param level
   */
  public final void setLevel(final int level) { this.level = level; }
   ...
   */
  public final boolean store() { return store; }
   ...
   * @param store
   */
  public final void store(final boolean store) { this.store = store; }
