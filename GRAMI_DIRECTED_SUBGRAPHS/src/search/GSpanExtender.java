 ...
 *            .equals(..))
 */
public class GSpanExtender<NodeType, EdgeType>
  ...
  getChildren(final Collection<SearchLatticeNode<NodeType, EdgeType>> nodes) {
   ...
   */
  public Collection<SearchLatticeNode<NodeType, EdgeType>>
  getChildren(final SearchLatticeNode<NodeType, EdgeType> node) {
