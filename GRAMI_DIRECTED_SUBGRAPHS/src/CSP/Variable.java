...
public class Variable {
  ...
  public void setDistanceConstrainedBy(
      ArrayList<MyPair<Integer, Double>> distanceConstrainedBy) {
    this.distanceConstrainedBy = distanceConstrainedBy;
  }

  public Variable(int ID, int label, HashMap<Integer, myNode> list,
  ...
  public int getConstraintDegree() { return distanceConstrainedWith.size(); }

  public void setList(HashMap<Integer, myNode> list) { this.list = list; }
  ...
  public HashMap<Integer, myNode> getList() { return list; }
