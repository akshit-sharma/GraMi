 ...
 *            .equals(..))
 */
public class MinExtensionSet<NodeType, EdgeType>
    extends MinExtension<NodeType, EdgeType> {
   ...
   *
   * @see
   *     de.parsemis.algorithms.gSpan.MinExtension#compareTo(de.parsemis.algorithms.gSpan.MinExtension)
   */
  @Override
   ...
   */
  public boolean isEmpty() { return this.forward == this; }
   ...
   */
  public boolean
  removeAndFree(final MinExtension<NodeType, EdgeType> extension) {
    if (extension.forward == null || extension.backward == null) {
      return false;
    }
  ...
  public boolean removeAndFreeAll(MinExtension<NodeType, EdgeType> ext) {
    ...
    while (ext != null) {
      final MinExtension<NodeType, EdgeType> next =
          (MinExtension<NodeType, EdgeType>)ext.next;
      ext.next = null;
   ...
   */
  public final MinExtension<NodeType, EdgeType>
  unlink(final MinExtension<NodeType, EdgeType> extension) {
