 ...
 *            .equals(..))
 */
public class MinExtension<NodeType, EdgeType>
    extends GSpanEdge<NodeType, EdgeType> {
  ...
  protected MinExtension<NodeType, EdgeType>
  set(final int nodeA, final int nodeB, final int labelA, final int edgeLabel,
      ...
      int theLabelA, int theLabelB) {
    super.set(nodeA, nodeB, labelA, edgeLabel, labelB, dir, theLabelA,
              theLabelB);
    this.gNodeBi = gNodeB;
    this.gEdgei = gEdge;
    return this;
