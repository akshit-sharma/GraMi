...
public class GSpanEdge<NodeType, EdgeType>
  ...
  public int getThelabelA() { return ThelabelA; }

  public int getThelabelB() { return ThelabelB; }
  ...
  public GSpanEdge<NodeType, EdgeType> clone() {
    return new GSpanEdge<NodeType, EdgeType>().set(nodeA, nodeB, labelA,
                                                   edgeLabel, labelB, direction,
                                                   ThelabelA, ThelabelB);
  }
  ...
  @Override
  public int hashCode() {
    return nodeA << 20 + nodeB << 16 + labelA << 12 + labelB << 8 + edgeLabel
                 << 4 + direction;
  }

  /** @return if this edge is a forward edge */
  public final boolean isForward() { return nodeA < nodeB; }
   ...
   */
  public GSpanEdge<NodeType, EdgeType>
  set(final int nodeA, final int nodeB, final int labelA, final int edgeLabel,
      final int labelB, final int direction, int THElabelA, int THElabelB) {
    this.nodeA = nodeA;
    this.nodeB = nodeB;
